...
function Player(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])("rgb(255,255,255)"),
      ...
      backColor = _useState2[0],
      setBackColor = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])("rgb(0,0,0)"),
      _useState4 = _slicedToArray(_useState3, 2),
      foreColor = _useState4[0],
      setForeColor = _useState4[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    props.imgSrc && Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["getColorSet"])(props.imgSrc, distThreshold, function (colorSet) {
      setBackColor(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["rgb2str"])(colorSet.chairColor));
      setForeColor(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["rgb2str"])(colorSet.viceColor));
    });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    id: "player-box__content"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    id: "player-box__img"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
    src: props.imgSrc
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    id: "player-box__right-box"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_pages_index__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.getElementById("app"));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _component_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../component/player */ "./src/component/player.js");
/* harmony import */ var _utils_context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/context */ "./src/utils/context.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
function Index() {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(0.25),
      _useState2 = _slicedToArray(_useState, 2),
      distThreshold = _useState2[0],
      setDistThreshold = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(""),
      _useState4 = _slicedToArray(_useState3, 2),
      imgId = _useState4[0],
      setImgId = _useState4[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    var match = window.location.search.match(/s=(\d+)/);

    if (match && match[1] !== undefined) {
      setImgId("http://localhost:8000/source/img/".concat(match[1], ".jpg"));
    }
  }, []);
...
/*!******************************!*\
  !*** ./src/utils/context.js ***!
  \******************************/
/*! exports provided: distThresholdContext */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "distThresholdContext", function() { return distThresholdContext; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);

var distThresholdContext = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext(0.5);
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: getColorSet, rgb2str */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getColorSet", function() { return getColorSet; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rgb2str", function() { return rgb2str; });
/**
 * 获取图片中像素（排序完成）
 * @param {String} ctx
 */
function getCtxSortedColors(ctx) {
  ...
  for (var i = 0, len = imgData.data.length, cnt = 0; i < len; i += 4, cnt++) {
    var _ref = [imgData.data[i], imgData.data[i + 1], imgData.data[i + 2], imgData.data[i + 3]],
        r = _ref[0],
        g = _ref[1],
        b = _ref[2],
        a = _ref[3]; // calc the cartesian coordinates

    var x = cnt % imgWidth;
    var y = cnt / imgHeight; // calc the weight

    var weight = 1;
    var distFromCenter = Math.min(Math.min(x, imgWidth - x), Math.min(y, imgHeight - y));
    weight += (imgWidth / 2 - distFromCenter) * 1; // statistical data

    if (map["".concat(r).concat(g).concat(b)] === undefined) {
      map["".concat(r).concat(g).concat(b)] = retArr.length;
      retArr.push({
        r: r,
        g: g,
        b: b,
      ...
      retArr[map["".concat(r).concat(g).concat(b)]].weight += weight;
    }
  }
...
function getColorDist(a, b) {
  var dist = Math.sqrt(Math.pow(a.r - b.r, 2) + Math.pow(a.g - b.g, 2) + Math.pow(a.b - b.b, 2));
...
function getColorSet(imgSrc) {
  ...
  img.onload = function () {
    ...
    var sortedArr = getCtxSortedColors(ctx);
    var arrLen = sortedArr.length;
    chairColor = sortedArr[0];

    for (var i = 1, dist; i < arrLen; i++) {
    ...
    typeof callback === "function" && callback.call(undefined, {
      chairColor: chairColor,
      viceColor: viceColor
    });
  };
}
function rgb2str(_ref2) {
  var r = _ref2.r,
      g = _ref2.g,
      b = _ref2.b;
